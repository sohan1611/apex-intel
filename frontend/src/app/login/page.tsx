    ...
    <div className="w-full max-w-md bg-bg-secondary border border-border-default rounded-2xl shadow-xl overflow-hidden p-8 text-center relative z-10 my-8">
      ...
      <div className="space-y-3">
        <button 
          ...
          className="w-full bg-bg-tertiary border border-border-default hover:bg-bg-elevated text-text-primary font-medium py-3 px-4 rounded-lg flex items-center justify-center gap-2 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {isGoogleLoading ? (
