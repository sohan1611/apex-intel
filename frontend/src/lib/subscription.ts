...
export const SUBSCRIPTION_PLANS: Record<SubscriptionTier, PlanConfig> = {
  ...
  PAY_PER_ANALYSIS: {
    ...
    features: [
      ...
      { name: 'Full 9-agent pipeline', included: true },
      { name: 'Contradiction detection engine', included: true },
      { name: 'Hidden assumptions validation', included: true },
      { name: 'Premium score breakdown', included: true },
      { name: 'Monthly quota reset', included: false },
  ...
  PRO_LITE: {
    ...
    features: [
      ...
      { name: 'Standard investment report', included: true },
